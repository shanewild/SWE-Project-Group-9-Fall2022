...
public class PizzaShop extends JFrame implements ActionListener{
...

    {
        ...
        pizzaSizesLabel = new JLabel("Pizza size: ");
        ...
        customerPanel.add(pizzaSizesLabel);
        ...
        customerPanel.add(breadSticksLabel);
        customerPanel.add(breadSticksCombo);
        customerPanel.add(breadStickBitesLabel);
        customerPanel.add(breadStickBitesCombo);
        customerPanel.add(chocolateCookieLabel);
        customerPanel.add(chocolateCookieCombo);
...

    {
...

        {
            ...
            if (breadSticksCounter!=0){
                report+="Bread Sticks $4 * " + breadSticksCounter+"\n";
